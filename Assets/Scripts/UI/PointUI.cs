...
public class PointUI : MonoBehaviour
{
    ...
    public void UpdateUI()
    {
        ...
        tiredLineObject.transform.localScale = new Vector3(tiredLineObject.transform.localScale.x, Mathf.Clamp01(1 - tirednessRatio), tiredLineObject.transform.localScale.z);
